...
def record_with_stack(strings: list):
   # push the valid values into a stack
   # if you encounter a c, pop
   # a d, double and insert
   # a + add up last two
   stack = []
...
print(record_with_stack(['5','2','C','D', '+'])) # 30
print(record_with_stack(['5','-2','4','C','D','9','+','+'])) # 27